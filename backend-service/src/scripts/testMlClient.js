/**
 * Standalone test: calls predictFraud() with one hardcoded features
 * object -- the same values used for the ML service's Phase 1 smoke
...
predictFraud(features)
  ...
  .catch((err) => {
    console.error("predictFraud failed:", err.message);
    process.exitCode = 1;
  });
